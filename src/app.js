  ...
  `;
   ...
   <h1>You aren't logged in yet!</h1>
    ...
    document.querySelector(
      ".right-side-nav"
    ).innerHTML = `<a class="nav-button" href="./login-page.html"><button>Log in</button></a>`;
  } else if (!Logged && userAccounts.length === 0) {
    newsContainers.forEach(
      (el) =>
    ...
    document.querySelector(
      ".right-side-nav"
    ).innerHTML = `<a class="nav-button" href="./login-page.html#signup"><button>Create an a</button></a>`;
  }
};
checkIfLoggedIn();
